...
using Abp.Hangfire;
using Abp.Owin;
using MyFirstWeb.Api.Controllers;
using MyFirstWeb.Web;
using Hangfire;
...
namespace MyFirstWeb.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in MyFirstWebWebModule)
